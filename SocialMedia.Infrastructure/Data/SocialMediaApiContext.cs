...
{
    public partial class SocialMediaApiContext : DbContext
    {
        public SocialMediaApiContext()
        {
        }

        public SocialMediaApiContext(DbContextOptions<SocialMediaApiContext> options)
            : base(options)
        {
        }
